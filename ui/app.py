...
# ── Firebase Auth & Sync — MOVED to ui/api/firebase_routes.py ────────────────
# Auth/sync/firebase routes now served by firebase_bp blueprint.
# Keeping duplicates below temporarily for safety — they won't conflict
# because Flask uses the first-registered route (blueprint wins).
